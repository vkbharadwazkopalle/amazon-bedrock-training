...
# # Define the image generation prompt for the model. Take user input (press Enter to use default).
# default_prompt = "A stylized picture of a cute old steampunk robot."
# try:
